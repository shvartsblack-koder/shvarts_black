...
const SOCIALS = [
  ...
  { name: 'Instagram', url: '#' },
  { name: 'TikTok', url: 'https://www.tiktok.com/@shvarts_black?_r=1&_t=ZS-99A4gPsiKYb' },
  { name: 'Facebook', url: 'https://www.facebook.com/people/Shvarts-Black/61590208422142/' },
];
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-16 md:py-24 lg:py-32 px-6 overflow-hidden">
