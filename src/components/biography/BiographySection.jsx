...
export default function BiographySection() {
  return (
    <section id="biography" className="relative py-16 md:py-24 lg:py-32 px-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <SectionReveal>
              ...
              <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-light tracking-wide gold-text mb-4">
                Biography
              </h2>
