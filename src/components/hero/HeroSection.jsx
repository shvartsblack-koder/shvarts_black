  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        >
          <h1 className="font-brand font-medium tracking-[0.25em] md:tracking-[0.5em] text-4xl sm:text-6xl md:text-7xl lg:text-8xl leading-none mb-2">
            <span className="gold-text">SHVARTS</span>
          </h1>
          <h1 className="font-brand font-bold tracking-[0.15em] md:tracking-[0.4em] text-4xl sm:text-6xl md:text-7xl lg:text-8xl leading-none text-foreground/90">
            BLACK
          </h1>
        </motion.div>
        ...
        >
          <p className="font-body text-xs sm:text-sm md:text-base tracking-[0.2em] sm:tracking-[0.3em] uppercase text-foreground/50 font-light">
